...
лучший вариант.
    ...
    - Новый термин: пользователь - тот кто сделал заказ от точки A до точки B. 
    - Новый термин: подача - сделал заказ
    - Новый термин: Суммарное время подачи - это общее затраченное время водителями в примере 
      это 2+10, то есть 12 минут
