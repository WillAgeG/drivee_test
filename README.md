...
<div align="left">
  ...
  Нужно ввести новую переменную как [рейтинг](https://habr.com/ru/companies/yandex/articles/507448/). В рейтинге будут учитываться ВСЁ. (Почему я использовал именно столько секунд, расписано здесь)
