...
~~При реализации использовал Distance Matrix API от 2GIS. Они мне все еще не дали ключ к их API~~
...
Думаю, для решения этого вопроса лучше всего использовать стороннее решение от 2GIS Distance Matrix API 
и некоторые библиотеки из Python - requests (просто, чтобы делать запрос к API).
...
В файле Drivee_test_v1_1.ipynb - приблизительная реализация
Docker файл не готов.
