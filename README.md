...
Необходимо лишь добавить время за которое он выполнит свой заказ + расстояние от точки B до нового
заказа. И возможно в редких ситуациях заказ будет распределятся курьеру который занят на данный момент.
...
системы рейтинга
    ...
    - Как часто опаздывает курьер для выполнения своего заказа. 
      ...
      то есть 16 минут, то это считать как опоздание.)
...
Дело в том, что это крайне неоптимально
