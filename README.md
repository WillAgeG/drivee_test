...
Затем уточняется время. Длина маршрута подачи курьера и с учётом этой информации выбирается 
лучший вариант.
...
Предположим сейчас у нас активно 2 заказа и свободных курьеров тоже 2. И пусть эти заказы находятся
...
даже 1 минуту. Так как если система крайне высоконагруженная, то кол-во заказов уже через минуту может быть
