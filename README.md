...
Далее, чтобы курьеры меньше простаивали, нужно ввести новую переменную как веса. Какие проблемы она решает?
    ...
    - Предположим, что всего у нас 2 курьера и 2 заказа. Один курьер оражевого цвета, 
      другой фиолетового. Если мы сразу распределим курьеров, то заказ А2 будет 
      выполнятся дольше если мы задействуем оранжевого курьера. В этой ситуации лучше 
      всего будет если два заказа возьмёт фиолетовый цвет, так как после выполнения 
      своего 1 заказа оранжевый будет на половине своего пути, тогда как фиолетовый 
      уже у заказа А2.
