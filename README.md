...
Если посмотреть на первую картинку и на вторую, то мы увидим, что при применении жадного 
алгоритма суммарное время подачи жадного алгоритма 12 мин, а венгерского алгоритма 8 мин.
